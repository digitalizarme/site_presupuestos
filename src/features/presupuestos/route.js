...
export default {
  ...
  childRoutes: [
    ...
    { path: 'aprobados/editar/:id', name: 'Editar presupuesto', component: FormPresupuestosContainer, protegido:true },
    { path: 'concluidos/editar/:id', name: 'Editar presupuesto', component: FormPresupuestosContainer, protegido:true },
